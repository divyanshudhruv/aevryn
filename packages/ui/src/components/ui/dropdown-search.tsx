...
import { SURFACE_BG } from "@aevryn/ui/lib/surface-classes";
	...
	(
		...
		return (
			<div
				...
				className={cn(
					"group/search sticky top-0 z-20 -mx-1 -mt-1 mb-0.5 flex shrink-0 items-center border-border/60 border-b",
					SURFACE_BG[surface],
					sizeClasses.control,
					sizeClasses.gap,
					compact ? "px-2.5" : "px-3",
